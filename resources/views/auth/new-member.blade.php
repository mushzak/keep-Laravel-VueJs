    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('new-member.store', $invite->token) }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('email') ? ' text-danger' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" class="form-control" name="email" value="{{ old('email') ?? $invite->email }}" required>
