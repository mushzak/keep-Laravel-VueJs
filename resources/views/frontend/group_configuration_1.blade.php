...
$screen1=new class{};
$screen1->order= 1;
$screen1->description='We Are the chum group';
$screen2=new class{};
$screen2->order= 2;
$screen2->description='chum chum chum';
...
@section('content')
  <div class="container">
      ...
      <ul class="nav nav-tabs mb-2">
            <li class="nav-item">
              <a class="nav-link active" href="{{ route('frontend.group_configuration_1') }}">What We Are About</a>
            </li>
            <li class="nav-item">
      ...
      <div class="form-group row">
        ...
        <textarea class="form-control col-sm-7 col-lg-9" rows="5" placeholder="Enter What We Are About Here">{{$screen->description}}</textarea>
        <div class="col-1 ">
