...
@section('content')
  <div class="container">
      ...
      <ul class="nav nav-tabs mb-2">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="{{ route('frontend.group_configuration_7') }}">Member Engagement</a>
            </li>
      </ul>

      <div class="row mt-2 mb-2">
        <label class="col-form-label mr-1 col-md-4 col-lg-2">
          Default for New User Notifications Frequency:
        </label>
      ...
      <div class="row mb-2">
        <label class="col-form-label mr-1 col-md-4 col-lg-2">
          Default New User Notification Mechanism:
        </label>
        <select class="form-control col-md-4 col-lg-3">
          <option>Email</option>
