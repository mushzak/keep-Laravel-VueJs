  ...
  <div class="container">
      <div class="row">
        <div class="col-lg-12">
          ...
          <ul class="nav nav-tabs">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="{{ route('frontend.group_insights_2') }}">Feedback</a>
            </li>
            <li class="nav-item">
      ...
      <div class="ml-5 mt-5 mb-5 ">
        <div class="row align-items-center">
          <h3 class="mr-5 align-center">Overall <br> 7.5</h3> <div class="col-md-6"> <feedback-chart></feedback-chart></div>
        </div>
      </div>
