...
class ShowMeetingTest extends TestCase
{
    ...
    /** @test */
    public function a_group_member_can_view_a_specific_meeting()
    {
    ...
    /** @test */
    public function non_group_members_cannot_view_a_specific_meeting()
    {
    ...
    /** @test */
    public function unauthenticated_users_cannot_view_a_specific_meeting()
    {
        $this->get("/groups/{$this->group->slug}/meetings/{$this->meeting->id}")
